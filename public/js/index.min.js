...
document.addEventListener('DOMContentLoaded', function () {
  // accordion
  var acc = document.querySelectorAll('.accordion__item_button');
  ...
  function randomNumber(max) {
    var randomNumb = max - Math.random() * 1000;
    return randomNumb;
  } //audio


  var audio = document.querySelector('.music');
  var sound = document.querySelector('.banner');
  var everlibParent = document.querySelector('.everlib-logo');
  var everlibs = everlibParent.querySelectorAll('span');
  sound.addEventListener('click', function () {
    ...
    for (var k = 0; k < everlibs.length; k++) {
  ...
  var bannerMove = document.querySelector('#banner-move');
  ...
  if (bodyScroll != null && bodyScroll.classList.contains('no-scroll')) {
    var bodyScrollRemove = function bodyScrollRemove() {
